...
const OrderInfo = (props) => {
    ...
    //     let v = `name: 'Белобородов-А-Д',
    //     customerId: '415',
    //     cost: 90000,
    //     customerFeedback: 'отличноe',
    //     technicalTask: 'Техническое задание, или ТЗ — это документ, в котором фиксируются требования к проекту. Условно ТЗ можно назвать 
    //   любое поручение исполнителю, главное, чтобы в нем были ясно прописаны характеристики итогового продукта.',
    //     orderType: 'персональный сайт',
    //     id: '452'`

    //     let vs = `id: '452',
    //     name: 'Белобородов-А-Д',
    //     customer_id: '415',
    //     cost: 90000,
    //     technical_task: 'Техническое задание, или ТЗ — это документ, в котором фиксируются требования к проекту. Условно ТЗ можно назвать любое поручение исполнителю, главное, чтобы в нем были ясно прописаны характеристики итогового продукта.',
    //     customer_feedback: 'wef',
    //     order_type: 'персональный сайт',`
